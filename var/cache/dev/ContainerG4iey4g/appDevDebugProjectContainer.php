...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = array())
    {
        ...
        $this->methodMap = array(
            ...
            'admin.commentaire' => 'getAdmin_CommentaireService',
        ...
        $this->privates = array(
            ...
            'sonata.admin.block.admin_list' => true,
            'sonata.admin.block.search_result' => true,
            'sonata.admin.block.stats' => true,
            ...
            'sonata.admin.menu.matcher.voter.children' => true,
            ...
            'sonata.admin.route.query_string' => true,
            ...
            'sonata.admin.twig.global' => true,
            'sonata.admin.validator.inline' => true,
        ...
        include_once $this->targetDirs[3].'/vendor/sonata-project/block-bundle/Profiler/DataCollector/BlockDataCollector.php';
        ...
        include_once $this->targetDirs[3].'/vendor/sonata-project/block-bundle/Twig/Extension/BlockExtension.php';
        ...
        include_once $this->targetDirs[3].'/vendor/sonata-project/core-bundle/Component/Status/StatusClassRendererInterface.php';
        include_once $this->targetDirs[3].'/vendor/sonata-project/core-bundle/FlashMessage/FlashManager.php';
        include_once $this->targetDirs[3].'/vendor/sonata-project/core-bundle/Twig/Extension/FlashMessageExtension.php';
        include_once $this->targetDirs[3].'/vendor/twig/twig/lib/Twig/Extension/GlobalsInterface.php';
        include_once $this->targetDirs[3].'/vendor/sonata-project/core-bundle/Twig/Extension/FormTypeExtension.php';
        include_once $this->targetDirs[3].'/vendor/twig/extensions/lib/Twig/Extensions/Extension/Text.php';
        include_once $this->targetDirs[3].'/vendor/sonata-project/core-bundle/Twig/Extension/DeprecatedTextExtension.php';
        include_once $this->targetDirs[3].'/vendor/sonata-project/core-bundle/Twig/Extension/StatusExtension.php';
        include_once $this->targetDirs[3].'/vendor/sonata-project/core-bundle/Twig/Extension/TemplateExtension.php';
        include_once $this->targetDirs[3].'/vendor/sonata-project/core-bundle/Model/Adapter/AdapterInterface.php';
        include_once $this->targetDirs[3].'/vendor/sonata-project/core-bundle/Model/Adapter/DoctrineORMAdapter.php';
        include_once $this->targetDirs[3].'/vendor/sonata-project/core-bundle/Model/Adapter/AdapterChain.php';
        include_once $this->targetDirs[3].'/vendor/sonata-project/block-bundle/Block/BlockServiceManagerInterface.php';
        include_once $this->targetDirs[3].'/vendor/sonata-project/block-bundle/Block/BlockServiceManager.php';
        include_once $this->targetDirs[3].'/vendor/sonata-project/block-bundle/Block/BlockContextManagerInterface.php';
        include_once $this->targetDirs[3].'/vendor/sonata-project/block-bundle/Block/BlockContextManager.php';
        include_once $this->targetDirs[3].'/vendor/sonata-project/block-bundle/Block/BlockRendererInterface.php';
        include_once $this->targetDirs[3].'/vendor/sonata-project/block-bundle/Block/BlockRenderer.php';
        ...
        include_once $this->targetDirs[3].'/vendor/sonata-project/block-bundle/Templating/Helper/BlockHelper.php';
        include_once $this->targetDirs[3].'/vendor/sonata-project/block-bundle/Block/BlockLoaderInterface.php';
        include_once $this->targetDirs[3].'/vendor/sonata-project/block-bundle/Block/BlockLoaderChain.php';
        include_once $this->targetDirs[3].'/vendor/sonata-project/block-bundle/Block/Loader/ServiceLoader.php';
        include_once $this->targetDirs[3].'/vendor/sonata-project/block-bundle/Twig/GlobalVariables.php';
        include_once $this->targetDirs[3].'/vendor/sonata-project/block-bundle/Cache/HttpCacheHandlerInterface.php';
        include_once $this->targetDirs[3].'/vendor/sonata-project/block-bundle/Cache/HttpCacheHandler.php';
        include_once $this->targetDirs[3].'/vendor/sonata-project/block-bundle/Exception/Strategy/StrategyManagerInterface.php';
        include_once $this->targetDirs[3].'/vendor/sonata-project/block-bundle/Exception/Strategy/StrategyManager.php';
        include_once $this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Twig/Extension/SonataAdminExtension.php';
        include_once $this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Admin/Pool.php';
        include_once $this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Twig/GlobalVariables.php';
        include_once $this->targetDirs[3].'/vendor/knplabs/knp-menu/src/Knp/Menu/Matcher/Voter/VoterInterface.php';
        include_once $this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Menu/Matcher/Voter/AdminVoter.php';
        include_once $this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Menu/Matcher/Voter/ChildrenVoter.php';
        include_once $this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Menu/Matcher/Voter/ActiveVoter.php';
        ...
        include_once $this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Menu/Provider/GroupMenuProvider.php';
    ...
    /**
     * Gets the public 'admin.blog' autowired service.
     *
     * @return \AppBundle\Admin\BlogAdmin
     */
    protected function getAdmin_BlogService()
    {
        include_once $this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Admin/AdminInterface.php';
        include_once $this->targetDirs[3].'/vendor/symfony/security-acl/Model/DomainObjectInterface.php';
        include_once $this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Admin/AbstractAdmin.php';
        include_once $this->targetDirs[3].'/src/AppBundle/Admin/BlogAdmin.php';
        include_once $this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Security/Handler/SecurityHandlerInterface.php';
        include_once $this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Security/Handler/NoopSecurityHandler.php';
        ...
        $instance = new \AppBundle\Admin\BlogAdmin('admin.blog', 'AppBundle\\Entity\\Blog', 'SonataAdminBundle:CRUD');
        ...
        $instance->setMenuFactory(${($_ = isset($this->services['knp_menu.factory']) ? $this->services['knp_menu.factory'] : $this->getKnpMenu_FactoryService()) && false ?: '_'});
    ...
    /**
     * Gets the public 'admin.commentaire' autowired service.
     *
     * @return \AppBundle\Admin\CommentairesAdmin
     */
    protected function getAdmin_CommentaireService()
    {
        include_once $this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Admin/AdminInterface.php';
        include_once $this->targetDirs[3].'/vendor/symfony/security-acl/Model/DomainObjectInterface.php';
        include_once $this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Admin/AbstractAdmin.php';
        include_once $this->targetDirs[3].'/src/AppBundle/Admin/CommentairesAdmin.php';
        include_once $this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Security/Handler/SecurityHandlerInterface.php';
        include_once $this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Security/Handler/NoopSecurityHandler.php';
        include_once $this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Translator/LabelTranslatorStrategyInterface.php';
        include_once $this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Translator/NativeLabelTranslatorStrategy.php';

        $instance = new \AppBundle\Admin\CommentairesAdmin('admin.commentaire', 'AppBundle\\Entity\\commentaires', 'SonataAdminBundle:CRUD');
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('791UjlQmeb', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('uABoNMnYWB', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('4zcO05iXS6', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('WxgdbGU-PX', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    protected function getKnpMenu_MatcherService()
    {
        ...
        $instance->addVoter(${($_ = isset($this->services['sonata.admin.menu.matcher.voter.admin']) ? $this->services['sonata.admin.menu.matcher.voter.admin'] : $this->services['sonata.admin.menu.matcher.voter.admin'] = new \Sonata\AdminBundle\Menu\Matcher\Voter\AdminVoter()) && false ?: '_'});
        $instance->addVoter(${($_ = isset($this->services['sonata.admin.menu.matcher.voter.children']) ? $this->services['sonata.admin.menu.matcher.voter.children'] : $this->getSonata_Admin_Menu_Matcher_Voter_ChildrenService()) && false ?: '_'});
        $instance->addVoter(${($_ = isset($this->services['sonata.admin.menu.matcher.voter.active']) ? $this->services['sonata.admin.menu.matcher.voter.active'] : $this->services['sonata.admin.menu.matcher.voter.active'] = new \Sonata\AdminBundle\Menu\Matcher\Voter\ActiveVoter()) && false ?: '_'});
        $instance->addVoter(${($_ = isset($this->services['knp_menu.voter.router']) ? $this->services['knp_menu.voter.router'] : $this->services['knp_menu.voter.router'] = new \Knp\Menu\Matcher\Voter\RouteVoter()) && false ?: '_'});
    ...
    /**
     * Gets the private 'sonata.admin.menu.matcher.voter.children' shared service.
     *
    ...
    {
        $a = ${($_ = isset($this->services['knp_menu.matcher']) ? $this->services['knp_menu.matcher'] : $this->getKnpMenu_MatcherService()) && false ?: '_'};

        if (isset($this->services['sonata.admin.menu.matcher.voter.children'])) {
            return $this->services['sonata.admin.menu.matcher.voter.children'];
        }

        return $this->services['sonata.admin.menu.matcher.voter.children'] = new \Sonata\AdminBundle\Menu\Matcher\Voter\ChildrenVoter($a);
    }
    ...
    {
        include_once $this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Filter/FilterInterface.php';
        include_once $this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Filter/Filter.php';
        include_once $this->targetDirs[3].'/vendor/sonata-project/doctrine-orm-admin-bundle/Filter/Filter.php';
        include_once $this->targetDirs[3].'/vendor/sonata-project/doctrine-orm-admin-bundle/Filter/BooleanFilter.php';
    ...
    protected function getSonata_Admin_Orm_Filter_Type_CallbackService()
    {
        ...
        include_once $this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Filter/Filter.php';
        include_once $this->targetDirs[3].'/vendor/sonata-project/doctrine-orm-admin-bundle/Filter/Filter.php';
        include_once $this->targetDirs[3].'/vendor/sonata-project/doctrine-orm-admin-bundle/Filter/CallbackFilter.php';
    ...
    protected function getSonata_Admin_Orm_Filter_Type_ChoiceService()
    {
        ...
        include_once $this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Filter/Filter.php';
        include_once $this->targetDirs[3].'/vendor/sonata-project/doctrine-orm-admin-bundle/Filter/Filter.php';
        include_once $this->targetDirs[3].'/vendor/sonata-project/doctrine-orm-admin-bundle/Filter/ChoiceFilter.php';
    ...
    protected function getSonata_Admin_Orm_Filter_Type_ClassService()
    {
        ...
        include_once $this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Filter/Filter.php';
        include_once $this->targetDirs[3].'/vendor/sonata-project/doctrine-orm-admin-bundle/Filter/Filter.php';
        include_once $this->targetDirs[3].'/vendor/sonata-project/doctrine-orm-admin-bundle/Filter/ClassFilter.php';
    ...
    protected function getSonata_Admin_Orm_Filter_Type_DateService()
    {
        ...
        include_once $this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Filter/Filter.php';
        include_once $this->targetDirs[3].'/vendor/sonata-project/doctrine-orm-admin-bundle/Filter/Filter.php';
        include_once $this->targetDirs[3].'/vendor/sonata-project/doctrine-orm-admin-bundle/Filter/AbstractDateFilter.php';
        include_once $this->targetDirs[3].'/vendor/sonata-project/doctrine-orm-admin-bundle/Filter/DateFilter.php';
    ...
    protected function getSonata_Admin_Orm_Filter_Type_DateRangeService()
    {
        ...
        include_once $this->targetDirs[3].'/vendor/sonata-project/doctrine-orm-admin-bundle/Filter/Filter.php';
        include_once $this->targetDirs[3].'/vendor/sonata-project/doctrine-orm-admin-bundle/Filter/AbstractDateFilter.php';
        include_once $this->targetDirs[3].'/vendor/sonata-project/doctrine-orm-admin-bundle/Filter/DateRangeFilter.php';
    ...
    protected function getSonata_Admin_Orm_Filter_Type_DatetimeService()
    {
        ...
        include_once $this->targetDirs[3].'/vendor/sonata-project/doctrine-orm-admin-bundle/Filter/Filter.php';
        include_once $this->targetDirs[3].'/vendor/sonata-project/doctrine-orm-admin-bundle/Filter/AbstractDateFilter.php';
        include_once $this->targetDirs[3].'/vendor/sonata-project/doctrine-orm-admin-bundle/Filter/DateTimeFilter.php';
    ...
    protected function getSonata_Admin_Orm_Filter_Type_DatetimeRangeService()
    {
        ...
        include_once $this->targetDirs[3].'/vendor/sonata-project/doctrine-orm-admin-bundle/Filter/Filter.php';
        include_once $this->targetDirs[3].'/vendor/sonata-project/doctrine-orm-admin-bundle/Filter/AbstractDateFilter.php';
        include_once $this->targetDirs[3].'/vendor/sonata-project/doctrine-orm-admin-bundle/Filter/DateTimeRangeFilter.php';
    ...
    protected function getSonata_Admin_Orm_Filter_Type_ModelService()
    {
        ...
        include_once $this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Filter/Filter.php';
        include_once $this->targetDirs[3].'/vendor/sonata-project/doctrine-orm-admin-bundle/Filter/Filter.php';
        include_once $this->targetDirs[3].'/vendor/sonata-project/doctrine-orm-admin-bundle/Filter/ModelFilter.php';
    ...
    protected function getSonata_Admin_Orm_Filter_Type_ModelAutocompleteService()
    {
        ...
        include_once $this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Filter/Filter.php';
        include_once $this->targetDirs[3].'/vendor/sonata-project/doctrine-orm-admin-bundle/Filter/Filter.php';
        include_once $this->targetDirs[3].'/vendor/sonata-project/doctrine-orm-admin-bundle/Filter/ModelAutocompleteFilter.php';
    ...
    protected function getSonata_Admin_Orm_Filter_Type_NumberService()
    {
        ...
        include_once $this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Filter/Filter.php';
        include_once $this->targetDirs[3].'/vendor/sonata-project/doctrine-orm-admin-bundle/Filter/Filter.php';
        include_once $this->targetDirs[3].'/vendor/sonata-project/doctrine-orm-admin-bundle/Filter/NumberFilter.php';
    ...
    protected function getSonata_Admin_Orm_Filter_Type_StringService()
    {
        ...
        include_once $this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Filter/Filter.php';
        include_once $this->targetDirs[3].'/vendor/sonata-project/doctrine-orm-admin-bundle/Filter/Filter.php';
        include_once $this->targetDirs[3].'/vendor/sonata-project/doctrine-orm-admin-bundle/Filter/StringFilter.php';
    ...
    protected function getSonata_Admin_Orm_Filter_Type_TimeService()
    {
        ...
        include_once $this->targetDirs[3].'/vendor/sonata-project/doctrine-orm-admin-bundle/Filter/Filter.php';
        include_once $this->targetDirs[3].'/vendor/sonata-project/doctrine-orm-admin-bundle/Filter/AbstractDateFilter.php';
        include_once $this->targetDirs[3].'/vendor/sonata-project/doctrine-orm-admin-bundle/Filter/TimeFilter.php';
    ...
    protected function getSonata_Admin_PoolService()
    {
        ...
        $instance->setTemplates($this->parameters['sonata.admin.configuration.templates']);
        $instance->setAdminServiceIds(array(0 => 'admin.blog', 1 => 'admin.commentaire'));
        $instance->setAdminGroups(array('default' => array('label' => 'default', 'label_catalogue' => 'SonataAdminBundle', 'icon' => '<i class="fa fa-folder"></i>', 'roles' => array(), 'on_top' => false, 'keep_open' => false, 'items' => array(0 => array('admin' => 'admin.blog', 'label' => 'blog', 'route' => '', 'route_params' => array(), 'route_absolute' => false), 1 => array('admin' => 'admin.commentaire', 'label' => 'commentaires', 'route' => '', 'route_params' => array(), 'route_absolute' => false)))));
        $instance->setAdminClasses(array('AppBundle\\Entity\\Blog' => array(0 => 'admin.blog'), 'AppBundle\\Entity\\commentaires' => array(0 => 'admin.commentaire')));

        return $instance;
    }

    /**
     * Gets the private 'sonata.admin.twig.extension' shared service.
     *
    ...
    /**
     * Gets the private 'sonata.admin.twig.global' shared service.
     *
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'mailer_user' => 'thomas.maurin@ynov.com',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'thomas.maurin@ynov.com',
            ...
            'fos_user.registration.confirmation.from_email' => array(
                'thomas.maurin@ynov.com' => 'thomas.maurin@ynov.com',
            ),
